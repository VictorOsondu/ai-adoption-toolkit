...
## Dimension A — Direction

**1. There's a named person accountable for how AI is adopted here.** Not a committee — a name.
`0 / 1 / 2`

**2. We can say, in one sentence, why we're adopting AI — and it's about a real outcome, not "keeping up".**
`0 / 1 / 2`

**3. Leaders here use AI themselves, visibly, rather than only sponsoring it for everyone else.**
`0 / 1 / 2`

## Dimension B — Guardrails

**4. We have a written, current AI use policy that staff have actually read.**
`0 / 1 / 2`

**5. Staff know what data must never be pasted into a public AI tool — and could tell you without checking.**
`0 / 1 / 2`

**6. There's a clear, blame-free way to report when something goes wrong with an AI tool.**
`0 / 1 / 2`

## Dimension C — Capability

**7. People have had real training on what AI does and where it fails — not just a link to a webinar.**
`0 / 1 / 2`

**8. At least a few people are past the "novelty" stage and use AI consistently for real work.**
`0 / 1 / 2`

**9. We know, roughly, where our people sit on the adoption curve — who's stuck, who's ahead.**
`0 / 1 / 2`

## Dimension D — Follow-through

**10. AI adoption has a small budget of time or money attached — it's not purely goodwill.**
`0 / 1 / 2`

**11. We review what's working every so often, rather than launching once and moving on.**
`0 / 1 / 2`

**12. New joiners are brought up to the same standard, automatically, not by chance.**
`0 / 1 / 2`
