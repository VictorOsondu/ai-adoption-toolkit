...
- **Anyone running an AI rollout** who needs to measure where their organisation actually stands before spending money.
- **L&D, Ops, and compliance leads** who want practical instruments, not consultancy slideware.
- **The audience playbooks themselves** — SMB, education, ministry, leaders — which reuse these tools rather than duplicating them.
...
Maintained by [Victor Osondu](https://aitutorium.com), Founder, AI Tutorium. Contributions welcome — see [CONTRIBUTING.md](CONTRIBUTING.md).
